...
public class Shili_input {
	...
	public static void main(String[] args) throws Exception {
		FileInputStream shlishuju_sourse=new FileInputStream("shili.xlsx");
		XSSFWorkbook wb_source=new XSSFWorkbook(shlishuju_sourse);
		...
		//读取目标文件并将数据写入目标文件
		FileInputStream shlishuju_dest=new FileInputStream("18rj2.xlsx");
		XSSFWorkbook wb_dest=new XSSFWorkbook(shlishuju_dest);
		...
		FileOutputStream shlishujushuchu_dest=new FileOutputStream("18rj2.xlsx");
		wb_dest.write(shlishujushuchu_dest);
		shlishujushuchu_dest.close();
	}
}
